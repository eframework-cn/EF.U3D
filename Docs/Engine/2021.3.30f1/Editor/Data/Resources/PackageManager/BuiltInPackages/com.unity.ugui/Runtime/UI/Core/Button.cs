...
namespace UnityEngine.UI
{
    ...
    public class Button : Selectable, IPointerClickHandler, ISubmitHandler
    {
        ...
        [SerializeField]
        private UnityEventEx m_OnClick = new UnityEventEx();
        ...
        [SerializeField]
        private UnityEventEx m_OnPress = new UnityEventEx();

        [FormerlySerializedAs("onRelease")]
        [SerializeField]
        private UnityEventEx m_OnRelease = new UnityEventEx();
        ...
        ///</code>
        ///</example>
        public UnityEventEx onClick
        {
            get { return m_OnClick; }
            set { m_OnClick = value; }
        }

        public UnityAction onClickEx { set { m_OnClick.RemoveAllListeners(); if (value != null) m_OnClick.AddListener(value); } }

        public UnityEventEx onPress
        {
            get { return m_OnPress; }
            set { m_OnPress = value; }
        }

        public UnityAction onPressEx { set { m_OnPress.RemoveAllListeners(); if (value != null) m_OnPress.AddListener(value); } }

        public UnityEventEx onRelease
        {
            get { return m_OnRelease; }
            set { m_OnRelease = value; }
        }

        public UnityAction onReleaseEx { set { m_OnRelease.RemoveAllListeners(); if (value != null) m_OnRelease.AddListener(value); } }
