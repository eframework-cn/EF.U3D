...
namespace UnityEngine.UI
{
    ...
    public class Toggle : Selectable, IPointerClickHandler, ISubmitHandler, ICanvasElement
    {
        ...
        ///</code>
        /// </example>
        public UnityEventEx<bool> onValueChanged = new UnityEventEx<bool>();

        public UnityAction<bool> onValueChangedEx { set { onValueChanged.RemoveAllListeners(); if (value != null) onValueChanged.AddListener(value); } }
