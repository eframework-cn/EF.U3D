...
async function main() {
    ...
    try {
        ...
        await Unity.Process(Const.BUILD_ARCHIVE, "Default", "Windows")
        await Unity.Process(Const.PUSH_ARCHIVE, "Default", "Windows")
        await Unity.Process(Const.BUILD_PATCH, "Default", "Android")
        await Unity.Process(Const.PUSH_PATCH, "Default", "Android")
        await Unity.Process(Const.BUILD_ARCHIVE, "Default", "Android")
        await Unity.Process(Const.PUSH_ARCHIVE, "Default", "Android")
