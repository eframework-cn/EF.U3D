...
--
local pb = require "pb"
module "Libs.protobuf.wire_format"
...
local function _VarUInt64ByteSizeNoTag(uint64)
    if uint64 <= 127 then return 1 end
    if uint64 <= 16383 then return 2 end
    if uint64 <= 2097151 then return 3 end
    if uint64 <= 268435455 then return 4 end
    return 5
end
