...
local pb = require "pb"
local wire_format = require "Libs.protobuf.wire_format"
local type_checkers = require "Libs.protobuf.type_checkers"
local encoder = require "Libs.protobuf.encoder"
local decoder = require "Libs.protobuf.decoder"
local listener_mod = require "Libs.protobuf.listener"
local containers = require "Libs.protobuf.containers"
local descriptor = require "Libs.protobuf.descriptor"
local FieldDescriptor = descriptor.FieldDescriptor
local text_format = require "Libs.protobuf.text_format"
local debugger = require "Libs.protobuf.debugger"

module("Libs.protobuf.protobuf")
...
local function _AddDebugMethod(message_meta)
    local debug_format = debugger.debug_format
    message_meta._member.__todebug = function(self)
        return debug_format(self)
    end
end
