...
public class LuaInterface_LuaFileUtilsWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("zipMap", get_zipMap, set_zipMap);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_zipMap(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			LuaInterface.LuaFileUtils obj = (LuaInterface.LuaFileUtils)o;
			System.Collections.Generic.Dictionary<string,UnityEngine.AssetBundle> ret = obj.zipMap;
			ToLua.PushSealed(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index zipMap on a nil value");
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_zipMap(IntPtr L)
	{
		object o = null;
