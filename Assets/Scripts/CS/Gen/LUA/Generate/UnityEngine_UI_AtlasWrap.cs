...
public class UnityEngine_UI_AtlasWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(UnityEngine.UI.Atlas), typeof(UnityEngine.MonoBehaviour));
	...
	static int GetSprite(IntPtr L)
	{
		try
		{
			...
			UnityEngine.UI.Atlas obj = (UnityEngine.UI.Atlas)ToLua.CheckObject<UnityEngine.UI.Atlas>(L, 1);
	...
	static int get_sprites(IntPtr L)
	{
		...
		try
		{
			...
			UnityEngine.UI.Atlas obj = (UnityEngine.UI.Atlas)o;
