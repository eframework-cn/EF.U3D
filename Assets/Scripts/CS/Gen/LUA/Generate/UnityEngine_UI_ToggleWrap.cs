...
public class UnityEngine_UI_ToggleWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("onValueChangedEx", null, set_onValueChangedEx);
	...
	static int get_onValueChanged(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.UI.Toggle obj = (UnityEngine.UI.Toggle)o;
			UnityEngine.UI.UnityEventEx<bool> ret = obj.onValueChanged;
	...
	static int set_onValueChanged(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.UI.Toggle obj = (UnityEngine.UI.Toggle)o;
			UnityEngine.UI.UnityEventEx<bool> arg0 = (UnityEngine.UI.UnityEventEx<bool>)ToLua.CheckObject<UnityEngine.UI.UnityEventEx<bool>>(L, 2);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_onValueChangedEx(IntPtr L)
	{
		object o = null;
		...
		try
		{
			...
			obj.onValueChangedEx = arg0;
			return 0;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index onValueChangedEx on a nil value");
		}
	}
