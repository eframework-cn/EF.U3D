...
public class EP_U3D_RUNTIME_LUA_LuaValueInfoWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(EP.U3D.RUNTIME.LUA.LuaValueInfo), typeof(System.Object));
		L.RegFunction("New", _CreateEP_U3D_RUNTIME_LUA_LuaValueInfo);
	...
	static int _CreateEP_U3D_RUNTIME_LUA_LuaValueInfo(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				EP.U3D.RUNTIME.LUA.LuaValueInfo obj = new EP.U3D.RUNTIME.LUA.LuaValueInfo();
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: EP.U3D.RUNTIME.LUA.LuaValueInfo.New");
			}
		}
		catch (Exception e)
		{
	...
	static int get_name(IntPtr L)
	{
		...
		try
		{
			...
			EP.U3D.RUNTIME.LUA.LuaValueInfo obj = (EP.U3D.RUNTIME.LUA.LuaValueInfo)o;
			string ret = obj.name;
