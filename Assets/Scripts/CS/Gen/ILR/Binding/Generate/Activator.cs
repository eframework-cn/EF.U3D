...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Activator_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(EP.U3D.LIBRARY.SCENE.ISceneAdapter.Adapter)};
            if (genericMethods.TryGetValue("CreateInstance", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(EP.U3D.LIBRARY.SCENE.ISceneAdapter.Adapter)))
                    {
        ...
        static StackObject* CreateInstance_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = System.Activator.CreateInstance<EP.U3D.LIBRARY.SCENE.ISceneAdapter.Adapter>();
