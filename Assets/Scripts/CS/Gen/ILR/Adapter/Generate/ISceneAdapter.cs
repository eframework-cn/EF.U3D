...
{   
    public class ISceneAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(EP.U3D.LIBRARY.SCENE.IScene);
            }
        }
        ...
        public class Adapter : EP.U3D.LIBRARY.SCENE.IScene, CrossBindingAdaptorType
        {
            ...
            public void Start(System.Object[] args)
            {
